...
class RestaurantTest {
    ...
    public void is_restaurant_open_should_return_true_if_time_is_between_opening_and_closing_time() {
        LocalTime validTime = LocalTime.parse("21:00:00");
        Restaurant restaurantSpy = getRestaurantForOpenCloseSetup(validTime);
    ...
    public void is_restaurant_open_should_return_false_if_time_is_outside_opening_and_closing_time() {
        ...
        Restaurant restaurantSpy = getRestaurantForOpenCloseSetup(outsideTime);
    ...
    private void getResturantBasicObject() {
        getResturantWithOnlyTimings();
    ...
    private Restaurant getRestaurantForOpenCloseSetup(LocalTime validTime) {
        getResturantWithOnlyTimings();
        restaurant.addToMenu("Sweet corn soup", 119);
        restaurant.addToMenu("Vegetable lasagne", 269);
